...
active_complaints = Gauge(
    "active_complaints_total", "Total number of active complaints", ["status"]
)

active_websocket_connections = Gauge(
    "websocket_connections_active", "Number of active WebSocket connections", ["role"]
)
