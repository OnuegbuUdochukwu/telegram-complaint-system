...
def test_purge_endpoint_as_admin():
    ...
    resp = httpx.delete(f"{BASE_URL}/api/v1/admin/purge", headers=headers, timeout=10.0)
...
def test_purge_with_filters():
    ...
    resp = httpx.delete(
        f"{BASE_URL}/api/v1/admin/purge", headers=headers, params=params, timeout=10.0
    )
...
def test_websocket_stats_as_admin():
    ...
    resp = httpx.get(
        f"{BASE_URL}/api/v1/websocket/stats", headers=headers, timeout=10.0
    )
